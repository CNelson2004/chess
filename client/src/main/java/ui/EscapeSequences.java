...
public class EscapeSequences {
    ...
    public static final String SET_TEXT_COLOR_GREEN = SET_TEXT_COLOR + "40m"; //46m
    public static final String SET_TEXT_COLOR_DARK_GREEN = SET_TEXT_COLOR + "34m"; //22m
    ...
    public static final String SET_TEXT_COLOR_LIGHT_BROWN = SET_TEXT_COLOR + "179m";
    ...
    public static final String SET_BG_COLOR_GREEN = SET_BG_COLOR + "40m"; //46m
    public static final String SET_BG_COLOR_DARK_GREEN = SET_BG_COLOR + "34m"; //22m
    ...
    public static final String SET_BG_COLOR_LIGHT_BROWN = SET_BG_COLOR + "179m";
    ...
    public static final String TRUE_EMPTY = "\u2003";
